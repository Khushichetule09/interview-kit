...
export const QUESTIONS: Question[] = [
  // DSA Questions
  {
    ...
    topicTags: ["Binary Search Tree", "Time Complexity"],
  ...
  },
  {
    ...
    topicTags: ["Stack", "Queue", "Data Structures"],
    subjectTags: ["DSA"]
  },
  {
    id: "q3",
    ...
    roleTags: ["Software Engineer", "Backend Developer"],
    topicTags: ["Linked List", "Cycle Detection", "Two Pointers"],
  ...
  },
  {
    ...
    topicTags: ["Sorting", "Algorithms", "Complexity Analysis"],
    subjectTags: ["DSA"]
  },
  ...
  // Operating Systems
  {
    ...
    difficulty: "Easy",
    type: "Technical",
    companyTags: ["Microsoft", "Amazon", "Google"],
    roleTags: ["Software Engineer", "Backend Developer", "System Engineer"],
    topicTags: ["Process", "Thread", "Concurrency"],
    subjectTags: ["OS"]
  },
  {
    id: "q6",
    ...
    topicTags: ["Deadlock", "Resource Management"],
  ...
  },
  {
    ...
    difficulty: "Medium",
    type: "Technical",
    companyTags: ["Microsoft", "Google", "Intel"],
    roleTags: ["System Engineer", "Software Engineer"],
    topicTags: ["Memory Management", "Paging", "Segmentation"],
    subjectTags: ["OS"]
  },
  ...
  // Database Management
  {
    ...
    difficulty: "Medium",
    type: "Technical",
    companyTags: ["Oracle", "Amazon", "Microsoft"],
    roleTags: ["Backend Developer", "Database Engineer", "Software Engineer"],
    topicTags: ["Normalization", "Database Design"],
    subjectTags: ["DBMS"]
  },
  {
    id: "q9",
    ...
    difficulty: "Easy",
    type: "Technical",
    companyTags: ["Oracle", "Amazon", "Microsoft", "Google"],
    roleTags: ["Backend Developer", "Database Engineer"],
    topicTags: ["Transactions", "ACID"],
    subjectTags: ["DBMS"]
  },
  {
    id: "q10",
    ...
    topicTags: ["Indexing", "Performance Optimization"],
    subjectTags: ["DBMS"]
  },
  ...
  },
  {
    ...
    topicTags: ["SOLID", "Design Principles"],
  ...
  // React / Frontend
  {
    ...
    topicTags: ["React Hooks", "State Management"],
  ...
  },
  {
    ...
    topicTags: ["Virtual DOM", "Performance", "React Internals"],
    subjectTags: ["React", "Frontend"]
  },
  {
    id: "q15",
    ...
    roleTags: ["Frontend Developer", "React Developer"],
    topicTags: ["Props", "State Management", "React Patterns"],
    subjectTags: ["React", "Frontend"]
  },
  ...
  // Behavioral
  {
    ...
    topicTags: ["Conflict Resolution", "Teamwork", "Communication"],
  ...
  },
  {
    ...
    roleTags: ["Software Engineer", "Full Stack Developer"],
    topicTags: ["Learning Agility", "Adaptability"],
  ...
  },
  {
    ...
    topicTags: ["Decision Making", "Communication", "Influence"],
    subjectTags: ["Behavioral", "Leadership"]
  },
  ...
  // Additional Technical Questions
  {
    ...
    topicTags: ["Optimization", "Caching", "Performance"],
  ...
  },
  {
    ...
    difficulty: "Medium",
    type: "Technical",
    companyTags: ["Amazon", "Google", "MongoDB", "Meta"],
    roleTags: ["Backend Developer", "Full Stack Developer"],
    topicTags: ["Databases", "System Design"],

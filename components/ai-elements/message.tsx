...
export const Message = ({ className, from, ...props }: MessageProps) => (
  <div
    className={cn(
      ...
      from === "user" ? "is-user py-4" : "is-assistant flex-row-reverse justify-end",
      className
    )}
    {...props}
  />
...
const messageContentVariants = cva(
  "is-user:dark flex flex-col gap-2 overflow-hidden text-sm",
  {
    variants: {
      variant: {
        contained: [
          "max-w-[80%] px-4 group-[.is-user]:py-3",
          "group-[.is-user]:bg-secondary/50 group-[.is-user]:text-foreground group-[.is-user]:inset-shadow-sm inset-shadow-primary/20",
          "group-[.is-assistant]:text-foreground",
        ],
        flat: [
          "group-[.is-user]:max-w-[80%] group-[.is-user]:bg-secondary/50 group-[.is-user]:text-foreground group-[.is-user]:inset-shadow-sm inset-shadow-primary/20 group-[.is-user]:px-4 group-[.is-user]:py-3",
          "group-[.is-assistant]:text-foreground",
        ],
      },
    },
...
// export type MessageResponseProps = ComponentProps<typeof Streamdown, >; and theme string
export type MessageResponseProps = ComponentProps<typeof Streamdown> & {
  theme?: string | undefined;
};

export const MessageResponse = ({ className, theme, ...props }: MessageResponseProps) => {
  const codePlugin = useMemo(() => {
    return createCodePlugin({ 
      themes: theme !== "light" ? ['github-dark', 'github-dark'] : ['github-light', 'github-light']
    });
  }, [theme]);

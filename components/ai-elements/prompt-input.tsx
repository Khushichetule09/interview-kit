...
export function PromptInputProvider({
  ...
  // Sync the ref with the latest attachmentFiles inside an effect to avoid
  // mutating refs during render (React warns against accessing refs in render).
  useEffect(() => {
    ...
    <PromptInputHoverCard>
      ...
      <PromptInputHoverCardContent className="w-auto p-2">
        <div className="w-auto space-y-3">
          {isImage && (
            <div className="flex max-h-48 w-48 items-center justify-center overflow-hidden rounded-md border">
              <img
